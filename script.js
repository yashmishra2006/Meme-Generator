...
function showJoke() {
  ...
  document.querySelector('.content').appendChild(joke);
}
...
function showQuote() {
  ...
  document.querySelector('.content').appendChild(quote);
...
function showRiddle() {
  ...
  question.className = "riddlequestion";
  question.textContent = randomRiddle.question;
  document.querySelector('.content').appendChild(question);
}
...
function revealAnswers() {
  ...
  answer.className = "riddleanswer";
  answer.textContent = randomRiddle.answer;
  if(document.querySelector('.riddlequestion') === null){
    window.alert("There is no riddle!")
  }
  else if(document.querySelector('.riddleanswer') !== null){
    window.alert('Answer already revealed');
  }
  else{
    document.querySelector('.content').appendChild(answer);
  }
}
